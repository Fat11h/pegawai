                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
										...
										$result = $mysqli->query("SELECT * FROM divisi where status=0");
										if($result->num_rows>0){
											...
											while($row=$result->fetch_assoc()){
												...
												<tr>
													...
													<td><a type='button' class='btn btn-danger btn-xs' href="hapus_divisi.php?id=<?php echo $row['id_divisi'];?>" onClick="return confirm('Apakah anda yakin mau menghapus data divisi ?');">Delete</a></td>
												</tr>
										<?php
											};
										};
